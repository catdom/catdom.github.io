...
This repository also carries its own Claude Code configuration: three project
skills in `.claude/skills/` and two design plugins declared in
`.claude/settings.json`, which install at session start.

See [`.claude/README.md`](.claude/README.md) for what each one does and how to
add your own.
