...
export const ui: L10n<Record<string, string>> = {
  en: {
    ...
    dsBody: 'The system this site is built on, drawn twice: as design, and as the specification a team builds from. Every number is the number the CSS sets, and the button and the tag are the site\u2019s own components, not copies of them.',
